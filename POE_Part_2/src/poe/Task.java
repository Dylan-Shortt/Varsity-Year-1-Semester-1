...
//**************************************************************************************//
    ...
    public String createTaskID(String taskName, int taskNumber, String developerDetails)
    {
       ...
       //create task ID
        ...
        //**************************************************************************************//
        if(developerDetails.contains(" "))
        {
            
            //seperates the string into the first name and surname
        firstNameOfDeveloper = developerDetails.substring(0, developerDetails.indexOf(" "));
            
        }
        else 
        {
            firstNameOfDeveloper = developerDetails;
        }
        //**************************************************************************************//
        
        //gets the length of the firstName
        int length = firstNameOfDeveloper.length();
        //**************************************************************************************//
