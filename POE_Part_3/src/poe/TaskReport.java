...
public class TaskReport { 
  ...
  //**************************************************************************************//
    ...
    public String StatusIsDone(int numberOfTasks)
    {
        ...
        for(int i = 0; i < numberOfTasks; i++)
        {
            ...
            if(Status_Array[i].toString().equals("Done"))
            {
                ...
                //if true add the array information to the string
                    //developer
                result += "Developer: " + Developer_Array[i] + "\n";
                //**************************************************************************************//
                
                //**************************************************************************************//
                    //task names
                result += "Task Names: " + TaskName_Array[i] + "\n";
                //**************************************************************************************//
                
                //**************************************************************************************//
                    //task IDs
                result += "Task ID: " + TaskID_Array[i] + "\n";
                //**************************************************************************************//
                
                //**************************************************************************************//
                    //task duration
                result += "Task Duration: " + Duration_Array[i] + "\n";
                //**************************************************************************************//
                
                //**************************************************************************************//
                    //task Status
                result += "Task Status: " + Status_Array[i] + "\n\n";
                //**************************************************************************************//
        ...
        if(test == false)
        {
            //print return string if no matching task was found
    ...
    public String longestDuration(int numberOfTasks)
    {
        ...
        //run through the array
         ...
         result += "Developer: " + Developer_Array[HighestPosition] + "\n";
         result += "Longest Duration: " + Duration_Array[HighestPosition];
         //**************************************************************************************//
    ...
    public String searchArrayTaskName(String name, int numberOfTasks)
    {
            ...
            //**************************************************************************************//
        {
                ...
                //**************************************************************************************//
            {
                //**************************************************************************************//
                //update output
                result += "Task Name: " + TaskName_Array[i] + "\n" 
                        + "Developer: " + Developer_Array[i] + "\n"
                        + "Task Status: " + Status_Array[i] + "\n" + "\n";
                test = true;
                //**************************************************************************************//
            }
        }
    ...
    for (int i = 0; i < numberOfTasks; i++) {
        ...
        boolean test = TaskName_Array[i].equals(targetName);
        str += "Condition : " + test;
        //**************************************************************************************//
    ...
    //**************************************************************************************//
        ...
        { 
            ...
            TaskName_Array[numberOfTasks - 1] = null;
            Developer_Array[numberOfTasks - 1] = null;
            Duration_Array[numberOfTasks - 1] = 0;
            Status_Array[numberOfTasks - 1] = null;

            //**************************************************************************************//
            //completion message on deletion
            JOptionPane.showMessageDialog(null, "Entry \"" + targetName + "\" successfully deleted");
            //**************************************************************************************//
    ...
    //**************************************************************************************//
    {
        ...
        for (int i = 0; i < numberOfTasks; i ++)
        {
            ...
            result += "Task Name: " + TaskName_Array[i] + "\n"
                    + "Task ID: " + TaskID_Array[i] + "\n"
                    + "Task Developer: " + Developer_Array[i] + "\n" 
                    + "Task Duration: " + Duration_Array[i] + "\n" 
                    + "Task Status: " + Status_Array[i] + "\n\n";
            //**************************************************************************************//
